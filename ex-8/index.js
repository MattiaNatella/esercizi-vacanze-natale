...
function categorizzaElfi(array){
  return array.map((elfo) => {
    return elfo.oreLavorate >= 5 ? {...elfo, carattere: "operoso"} : {...elfo, carattere: "pigro"}
  })
}

console.log (categorizzaElfi(elfi))